App = {
  ...
  render: function () {
    ...
    web3.eth.getAccounts(function (err, account) {
      $(
        "#accountAddress"
      ).html(`<span style="font-size:14px;">Your Voter's Address: 
    ...
    App.contracts.Election.deployed()
      ...
      .then(function (hasVoted) {
        ...
        if (hasVoted) {
          $("form").hide();
          $("#vote-msg")
            .html(`<div class="col-sm-6 offset-sm-3 col-lg-6 offset-lg-3 col-md-6 offset-md-3">
